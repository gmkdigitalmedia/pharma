...
class HCP(db.Model):
    ...
    user = db.relationship('User', backref=db.backref('hcps', lazy=True))
...
class ApiConnection(db.Model):
    ...
    custom_name = db.Column(db.String(50), nullable=True)  # For 'Custom' type
    ...
    def __repr__(self):
        return f'<ApiConnection {self.display_name}>'
